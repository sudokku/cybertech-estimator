...
- 2026-08-27 — Public demo options researched: WordPress Playground (free, no expiry, runs in the visitor's browser, no email/webhook) is the default shareable link and now installs the demo theme; TasteWP gives a 7-day free site (logged-in), InstaWP 48 h; Local Live Links / ngrok / cloudflared require Radu's Mac to stay on. The Local wp-config carries a WP_HOME override for tunnel hostnames.
